...
public final class NeoSteerControllerFactoryBuilder {
    ...
    public static class ControllerImplementation implements SteerController {
        ...
        public void setReferenceAngle(double referenceAngleRadians) {
            ...
            controller.setReference(adjustedReferenceAngleRadians, CANSparkMax.ControlType.kPosition);  //controller.setReference(adjustedReferenceAngleRadians, ControlType.kPosition); //Original line 156 code
